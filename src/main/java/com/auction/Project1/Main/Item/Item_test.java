...
public class Item_test {
	...
	private static ArrayList<Item_test> items = new ArrayList<>();
    ...
    public static void addItemIdToList(Item_test itemID) {
	...
	public static ArrayList<Item_test> getItems() {
		return items;
	}

	public static void setItems(Item_test item) {
		items.add(item);
	}
	...
	public Item_test(String itemID, String itemName, int startingPrice, int instantSellingPrice, String description, boolean isAvailable) {
		this.itemID = itemID;
		this.itemName = itemName;
		this.startingPrice = startingPrice;
	...
	public Item_test(String itemID) {
		this.itemID = itemID;
	}
