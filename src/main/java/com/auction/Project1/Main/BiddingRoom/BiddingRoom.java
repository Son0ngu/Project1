package com.auction.Project1.Main.BiddingRoom;

import com.auction.Project1.Main.Constructor.ItemInfo;
import com.auction.Project1.Main.Constructor.UserInfo;
...
public class BiddingRoom {
    ...
    public ResponseEntity<List<ItemInfo>> getBidItems(@PathVariable String id) {
        ...
        String query = "SELECT itemName,  startingPrice, instantSellPrice, description, seller_user_ID FROM Items WHERE itemID = ?";
